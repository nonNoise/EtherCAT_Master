...
print("EEPROM Deta Write")
d = [0x80,0x01,0x00,0xFF,0x00,0x00,0xFF,0x00,0x00,0x00,0x00,0x00,0x00,0x00]
#d = [0x80,0x00,0x00,0xCC,0x88,0x13,0xf0,0x00,0x00,0x00,0x00,0x80,0x00,0x00]
buf = [d[0]|d[1]<<8,d[2]|d[3]<<8,d[4]|d[5]<<8,d[6]|d[7]<<8,d[8]|d[9]<<8,d[10]|d[11]<<8,d[12]|d[13]<<8]
for i in range(7):
    cat.EEPROM_AddrSet(i)
